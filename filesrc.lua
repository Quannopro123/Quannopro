...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>quân prochào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "quânpro", HidePremium = false, IntroText = "quânpro⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("quân proSCRIPT")
W:AddLabel("Discordquânpro")
local Section = W:AddSection({
    Name = "Status"
})
